...
```{r}
load("/Users/judy/Desktop/EC4308/ec4308_usdjpy_result/rf_rolling_results.RData")
...
ggplot(ann_1m, aes(x = date)) +
  ...
  geom_line(aes(y = yhat, color = "Best Model Return"), size = 0.7) +
  geom_line(aes(y = rw_forecast, color = "Random Walk Return"), size = 0.5, linetype = "dashed") +
  scale_color_manual(
    values = c(
      "Actual Return" = "royalblue3",    
      "Best Model Return" = "red3",  
      "Random Walk Return" = "grey29"  
    )
  ) +
  scale_x_date(
  ...
  labs(
    title = "Actual vs Predicted vs Random Walk Log Returns (1 Month)",
    x = "Time",
    y = "Log Return",
    color = ""
  ) +
...
ggplot(rf_3m, aes(x = Date)) +
  ...
  geom_line(aes(y = Forecast, color = "Best Model Return"), size = 0.7) +
  geom_line(aes(y = rw_forecast, color = "Random Walk Return"), size = 0.5, linetype = "dashed") +
  scale_color_manual(
    values = c(
      "Actual Return" = "royalblue3",    
  ...
  labs(
    title = "Actual vs Predicted vs Random Walk Log Returns (3 Month)",
    x = "Time",
    y = "Log Return",
    color = ""
  ) +
...
ggplot(rf_6m, aes(x = Date)) +
  ...
  labs(
    title = "Actual vs Predicted vs Random Walk Log Returns (6 Month)",
    x = "Time",
    y = "Log Return",
    color = ""
  ) +
...
ggplot(rf_12m, aes(x = Date)) +
  ...
  labs(
    title = "Actual vs Predicted vs Random Walk Log Returns (12 Month)",
    x = "Time",
    y = "Log Return",
    color = ""
  ) +
